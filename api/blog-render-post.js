...
export default async function handler(req, res) {
  ...
  + '<article><header class="article-wrap"><div class="post-category">' + esc(post.category || '') + '</div><h1 class="post-title">' + esc(post.title) + '</h1><p class="post-intro">' + esc(post.intro || '') + '</p><div class="post-byline"><span>By the Theme Park Co-Pilot Team</span><span class="post-byline-dot"></span><span>' + formatDate(post.publishedAt) + '</span><span class="post-byline-dot"></span><span>' + esc(post.readTime || '8') + ' min read</span></div></header>'
  + '<div class="article-wrap"><div class="article-body">' + (post.body || '') + '</div>'
