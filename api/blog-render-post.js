...
function relatedHtml(related) {
  ...
  var cards = related.map(function(r) {
    ...
    return '<a href="https://themeparkcopilot.com/blog/' + esc(r.slug) + '" class="related-card"><span class="related-park">' + esc(rLabel) + '</span><span class="related-title">' + esc(r.title) + '</span><span class="related-link">Read guide \u2192</span></a>';
  }).join('');
