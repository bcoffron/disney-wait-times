...
export default async function handler(req, res) {
  ...
  + '<div class="post-back"><a href="/blog" class="post-back__btn">← Back to all guides</a></div><article><header class="article-wrap"><div class="post-category">' + (post.category || '').replace(/&middot;/g, '·').replace(/&amp;/g, '&') + '</div><h1 class="post-title">' + esc(post.title) + '</h1><div class="post-byline"><span>By the Theme Park Co-Pilot Team</span><span class="post-byline-dot"></span><span>' + formatDate(post.publishedAt) + '</span><span class="post-byline-dot"></span><span>' + esc(post.readTime || '8') + ' min read</span></div><p class="post-intro">' + esc(post.intro || '') + '</p></header>'
