async function handler(req,res){
    ...
    try{
      ...
      const model="claude-sonnet-4-6";
          const system='You are a Disneyland schedule optimizer. You MUST output ONLY a raw JSON object with zero additional text. Do not use markdown. Do not explain. Just JSON. CRITICAL: You MUST return a complete full-day schedule. Do NOT truncate or abbreviate. Return EVERY time slot from park open to park close. The optimized schedule must have at least as many entries as the original — do not omit any. Required output format: {"sections":[{"title":"Morning","entries":[{"t":"8:00 AM","h":"Ride Name","type":"ride","n":"short tip","land":"Land Name"}]}],"explanation":"one sentence summary"} — the sections array must contain ALL entries for the full day with no omissions.';
