...
function renderCard(post, isFeatured) {
  ...
  if (isFeatured) {
    return '<a class="post-card post-card--featured" href="/blog/' + slug + '" data-category="' + cat + '" aria-label="' + title + '"><div class="post-card__img-wrap"><img src="' + heroImage + '" alt="' + heroAlt + '" class="post-card__img" loading="eager"><span class="post-card__badge">START HERE</span></div><div class="post-card__body"><p class="post-card__eyebrow">' + catLabel + '</p><h2 class="post-card__title">' + title + '</h2><p class="post-card__intro">' + intro + '</p><div class="post-card__footer"><span class="post-card__read">' + readTime + ' min read</span><span class="post-card__cta">Read the guide →</span></div></div></a>';
  }
