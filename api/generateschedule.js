...
system += '\n9. CROSS-DAY CHECK: The already-used list in rule 6 contains venues from prior days. Never use any of them.';
      ...
      system += '\n\n=== VIP TOUR HOURS RULE (ABSOLUTE - OVERRIDES MORNING RHYTHM AND NO-GAPS RULES) ===';
          ...
          system += '\nABSOLUTELY FORBIDDEN: do NOT create a "VIP Tour Check-In", "VIP Tour Begins", "VIP Tour Complete", "VIP Tour Ends", "VIP Tour Wrap-Up" or any other VIP-related card. There is ONE card titled exactly "VIP Tour" and NOTHING else referencing the tour -- no check-in card before it, no completion card after it. Not at vipStart, not at vipEnd, not anywhere.';
          system += '\nThe card immediately before the VIP Tour card is a normal pre-tour activity; the card immediately after is a normal post-tour activity (e.g. dinner or a ride). Neither mentions the VIP tour.';
