...
module.exports = async function(req, res) {
  ...
  try {
    ...
    existing.section_meta[sectionName] = { built: true, length: typeof sectionData === 'string' ? sectionData.length : JSON.stringify(sectionData).length, last_edited: new Date().toISOString() };
    ...
    return res.json({ ok: true, key, sectionName, sectionLength: typeof sectionData === 'string' ? sectionData.length : JSON.stringify(sectionData).length });
